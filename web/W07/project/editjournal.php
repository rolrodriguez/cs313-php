  ...
  if(isset($user)){
    ...
    './css/style',), true);?>
      ...
      <div class="list-result app-form">
          ...
          <input type="text" name="journalname" id="journalname" required>
          <label for="journaldescription">Journal Description: </label>
          <input type="text" name="journaldescription" id="journaldescription" required>
          <input type="hidden" name="action" value="new">
          <input type="submit" class="btn-dark" value="Create Journal">
      </div>
      </form>
    <? break; ?>
    <?  case 'edit': ?>
      ...
      './css/style',), true);?>
        ...
        <form method="post">
          <div class="list-result app-form">
            <label for="journalname">Journal Name: </label>
            <input type="text" name="journalname" id="journalname" value="<? echo $journal[0]['journalname'] ?>" required>
            <label for="journaldescription">Journal Description: </label>
            <input type="text" name="journaldescription" id="journaldescription" value="<? echo $journal[0]['journaldescription'] ?>" required>
            <input type="hidden" name="journalid" value="<? echo $journal[0]['journalid'] ?>">
            <input type="hidden" name="action" value="edit">
            <input type="submit" class="btn-dark" value="Edit Journal">
          </div>
        </form>
    <?  break; ?>
    <? endswitch;?>
